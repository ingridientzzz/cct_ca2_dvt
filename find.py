...
def load_data(excel_file_path):
    # Load data from an Excel file, parse tables, save them as CSVs,
    # and return specific dataframes for density and age/gender.
